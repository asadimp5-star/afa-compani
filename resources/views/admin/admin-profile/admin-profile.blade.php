...
<section class="d-flex justify-content-center row">
  ...
  <div>
  <a href="{{ route('admin.users.user-pass' , Auth::user()->id  ) }}" class="btn btn-info sahel">تغییر رمز</a>

  </div>
  <div>
  <a href="{{ route('admin.users.user-email' , Auth::user()->id  ) }}" class="btn btn-info sahel">تغییر آدرس ایمیل</a>
