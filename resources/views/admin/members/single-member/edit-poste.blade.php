...
<x-manual.member-page-curent>
    <x-slot>
    <li class="breadcrumb-item p-1 active" aria-current="page">ویرایش مقاله</li>
    </x-slot>
...
<form action="{{ route('admin.posts.update',$Upost) }}" method="post" enctype="multipart/form-data">
  @csrf
  @method('PUT')

  <div class="col-md-6">
    <label for="title"  class="form-label d-block invalid">عنوان*</label>
    <input type="text" class="form-control" id="title" name="title" value="{{ $Upost->title }}" required>
    @error('title')
  ...
  <div class="card shadow-sm mt-2" > 
      <img src="{{ asset('storage/postsImg/'. $Upost->images0) }}" class="bd-placeholder-img card-img-top" height="225" role="img" width="100%" alt="{{ $Upost->title }}">
  ...
  <div class="mb-3 col-8">
    ...
    <textarea class="form-control" name="description" >{{ $Upost->description }}</textarea>
    @error('description')
       <div class="alert alert-danger mt-1">{{ $message }}</div>
    @enderror
  </div>
  ...
  <div class="card shadow-sm mt-2" > 
      <img src="{{ asset('storage/postsImg/'. $Upost->images) }}" class="bd-placeholder-img card-img-top" height="225" role="img" width="100%" alt="{{ $Upost->title }}">
...
<div class="card-body"> 
  ...
  <div class="mb-3 col-8">
    ...
    <textarea class="form-control" name="description1">{{ $Upost->description1 }}</textarea>
    @error('description1')
       <div class="alert alert-danger mt-1">{{ $message }}</div>
    @enderror
  </div>
  ...
  <div class="card shadow-sm mt-2" > 
      <img src="{{ asset('storage/postsImg/'. $Upost->images1) }}" class="bd-placeholder-img card-img-top" height="225" role="img" width="100%" alt="{{ $Upost->title }}">
...
<div class="card-body"> 
  ...
  <div class="mb-3 col-8">
    ...
    <textarea class="form-control" name="description2">{{ $Upost->description2 }}</textarea>
    @error('description2')
       <div class="alert alert-danger mt-1">{{ $message }}</div>
    @enderror
  </div>
