...
<x-manual.page-curent>
  <x-slot>
    ...
    <li class="breadcrumb-item p-1 active" aria-current="page">واکس تایر</li>
  </x-slot>
</x-manual.page-curent>
@endsection

@section('page-name','لیست محصولات واکس تایر')
...
<div class="col-3 pe-5">{{ $waxT->links() }}</div>
