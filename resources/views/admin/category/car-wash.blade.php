...
<x-manual.page-curent>
  <x-slot>
    ...
    <li class="breadcrumb-item p-1 active" aria-current="page">شامپو کارواش</li>
  </x-slot>
</x-manual.page-curent>
@endsection

@section('page-name','لیست محصولات کارواش')
...
<div class="col-3 pe-5">{{ $carWas->links() }}</div>
