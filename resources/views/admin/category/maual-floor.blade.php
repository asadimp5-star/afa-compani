...
<x-manual.page-curent>
  <x-slot>
    ...
    <li class="breadcrumb-item p-1 active" aria-current="page">کفشوی دستی</li>
  </x-slot>
</x-manual.page-curent>
@endsection

@section('page-name','لیست محصولات کفشوی دستی')
...
<div class="col-3 pe-5">{{ $Mfloo->links() }}</div>
