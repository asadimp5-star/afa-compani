...
<form action="#" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-6">
       <input  class="form-control" id="product_type" name="product_type" type="hidden" value=""  required>
    </div>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="title" name="product_code" value="" required>
    @error('product_code')
       <div class="alert alert-danger mt-1">{{ $message }}</div>
    @enderror
  ...
  <div class="card shadow-sm mt-2" > 
      <img src="#" class="bd-placeholder-img card-img-top" height="225" role="img" width="100%" alt="{{ $item->title }}">
